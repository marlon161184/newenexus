...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "O produto digital que materializa o Nosso Jeito de Ser." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Nexus · Hyndra | Newe" },
      { name: "twitter:description", content: "O produto digital que materializa o Nosso Jeito de Ser." },
